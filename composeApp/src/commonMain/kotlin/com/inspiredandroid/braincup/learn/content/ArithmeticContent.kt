...
internal object ArithmeticContent {
    ...
    private val negatives = learnUnit(
        ...
        summary = "Left of zero, and what the two signs do to each other.",
            ...
            LessonSpec(
                ...
                steps = listOf(
                    ...
                    Numeric(
                        ...
                        formula = "-2 - (-18) = ?",
                        answer = "16",
                        explanation = "Count the steps from -18 up to -2.",
            ...
            LessonSpec(
                ...
                steps = listOf(
                    ...
                    Choice(
                        ...
                        correctIndex = 2,
                        explanation = "Taking away {b:-9} moves nine steps right of {a:-2}.",
        ...
        questions = listOf(
            ...
            QuizQuestion(
                ...
                correctIndex = 0,
                explanation = "Furthest left on the line is the smallest.",
                visual = NumberLine(from = -10, to = 5, reveal = false),
            ),
            QuizQuestion(
                prompt = "-3 - 8 = ?",
                ...
                correctIndex = 0,
                explanation = "Eight steps left of -3.",
            ...
            QuizQuestion(
                ...
                correctIndex = 0,
                explanation = "Thirty-six shares into nines four times, and the signs differ.",
    ...
    private val ratio = learnUnit(
        ...
        questions = listOf(
            ...
            QuizQuestion(
                ...
                correctIndex = 0,
                explanation = "Both sides divide by five.",
                visual = RatioBar(parts = listOf(3, 5), reveal = false),
            ),
            QuizQuestion(
                ...
                correctIndex = 2,
                explanation = "One person takes 40 g.",
            ...
            QuizQuestion(
                ...
                correctIndex = 1,
                explanation = "30 m is 3000 cm, shared into 200.",
    ...
    private val percent = learnUnit(
            ...
            LessonSpec(
                ...
                steps = listOf(
                    ...
                    Choice(
                        ...
                        correctIndex = 1,
                        explanation = "The change is 50, measured against the original 200.",
        ...
        questions = listOf(
            ...
            QuizQuestion(
                ...
                correctIndex = 1,
                explanation = "Three quarters of 40.",
            ...
            QuizQuestion(
                ...
                correctIndex = 1,
                explanation = "45 squares out of a hundred.",
            ...
            QuizQuestion(
                ...
                correctIndex = 2,
                explanation = "The change is 10, measured against the original 40.",
            ...
            QuizQuestion(
                ...
                correctIndex = 0,
                explanation = "The rise is 20% of 100, but the fall is 20% of 120.",
    ...
    private val standardForm = learnUnit(
            ...
            LessonSpec(
                ...
                steps = listOf(
                    ...
                    Numeric(
                        ...
                        formula = "5.6 * 10^-4 = ?",
                        answer = "0.00056",
                        explanation = "0.56, 0.056, 0.0056, 0.00056.",
                        visual = Steps(terms = listOf(1, 10, 100, 1000), multiply = true),
                    ),
                    Concept(
            ...
            LessonSpec(
                ...
                steps = listOf(
                    ...
                    Choice(
                        ...
                        correctIndex = 0,
                        explanation = "4 shared by 2, and six jumps less two.",
                        visual = Steps(terms = listOf(4, 40, 400, 4000), multiply = true),
                    ),
                    Concept(
        ...
        questions = listOf(
            ...
            QuizQuestion(
                ...
                correctIndex = 2,
                explanation = "12 is outside the 1 to 10 window.",
            ...
            QuizQuestion(
                ...
                correctIndex = 0,
                explanation = "Four steps left of 4.",
            ...
            QuizQuestion(
                ...
                correctIndex = 0,
                explanation = "9 shared by 3, and eight jumps less five.",
    ...
    private val surds = learnUnit(
        ...
        urlSlug = "surds",
        title = "Surds",
        summary = "Roots that never finish, and how to keep them exact.",
        level = GradeLevel.GRADES_9_10,
        lessons = listOf(
            LessonSpec(
                id = "arithmetic-surds",
            ...
            LessonSpec(
                ...
                steps = listOf(
                    ...
                    Choice(
                        ...
                        correctIndex = 0,
                        explanation = "18 is 9 x 2, and √9 is exactly 3.",
                        visual = AreaGrid(cols = 3, rows = 3, showArea = false, unit = ""),
                    ),
                    Concept(
            ...
            LessonSpec(
                ...
                steps = listOf(
                    Concept(
                        body = "Surds collect the way like terms do in algebra. Matching roots add up, and the root itself never changes.",
                        formula = "2√3 + 4√3 = 6√3",
                        visual = AreaGrid(cols = 3, rows = 3, showArea = false, unit = ""),
                    ),
                    Choice(
        ...
        questions = listOf(
            ...
            QuizQuestion(
                ...
                correctIndex = 0,
                explanation = "45 is 9 x 5, and √9 is exactly 3.",
                visual = AreaGrid(cols = 3, rows = 3, showArea = false, unit = ""),
            ),
            QuizQuestion(
                prompt = "√6 x √6 = ?",
            ...
            QuizQuestion(
                ...
                correctIndex = 2,
                explanation = "49 and 64 are the square numbers either side of 50.",
                visual = AreaGrid(cols = 7, rows = 7, showArea = false, unit = ""),
            ),
        ),
    )
    ...
    private val bounds = learnUnit(
        ...
        summary = "What a rounded number hides, and how far the hidden range reaches.",
        level = GradeLevel.GRADES_9_10,
        lessons = listOf(
            LessonSpec(
            ...
            LessonSpec(
                ...
                steps = listOf(
                    ...
                    Concept(
                        body = "A nought in the middle of a number counts. A nought that only holds the point does not, which is the whole difference between 0.00308 and 308 000.",
            ...
            LessonSpec(
                ...
                steps = listOf(
                    ...
                    Numeric(
                        ...
                        answer = "115",
                        explanation = "Half of ten below 120.",
        ...
        questions = listOf(
            ...
            QuizQuestion(
                ...
                options = listOf("2", "3", "4", "5"),
                correctIndex = 1,
                explanation = "Counting starts at the 6, and the last nought was written on purpose.",
            ...
            QuizQuestion(
                ...
                correctIndex = 1,
                explanation = "Each one is at least 19.5 g.",
