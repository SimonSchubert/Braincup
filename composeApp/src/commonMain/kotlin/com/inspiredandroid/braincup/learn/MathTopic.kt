 ...
 *
 * The first release ships Arithmetic and Geometry only. The other six topics were written, then
 * cut to the frozen `learn-parked` branch; see `docs/learn-release-status.md` to restore one.
 */
